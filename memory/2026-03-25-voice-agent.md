...
# 6. Čo presne má byť v `projects/marek/`

Keďže Maklér je teraz aktívny, mal by mať vlastný projektový priečinok.  
To je presne to, čo teraz chýba.

## `projects/marek/brief.md`
- čo agent rieši
- pre koho
- V1 scope
- target outcomes

## `projects/marek/current-state.md`
- čo aktuálne existuje
- čo je live/staged
- čo je blocker

## `projects/marek/prompt.md`
- current system prompt
- maybe current first message
- patch notes

## `projects/marek/tools.md`
- attached tools
- tool purpose
- expected behavior
- missing tools

## `projects/marek/workflow.md`
- routing
- lane logic
- next-step engine
- handoff logic

## `projects/marek/knowledge.md`
- aké knowledge inputs agent má / potrebuje

## `projects/marek/review.md`
- review findings
- Jakub review prep
- founder comments

## `projects/marek/qa.md`
- QA pack
- tested / not tested
- failures / next tests

## `projects/marek/changelog.md`
...
3. **vytvorenie `method/`, `projects/marek/`, `inventory/`, `templates/` v správnom tvare**
...
- [ ] vytvoriť `projects/marek/`
- [ ] založiť `projects/marek/brief.md`
- [ ] založiť `projects/marek/current-state.md`
- [ ] založiť `projects/marek/prompt.md`
- [ ] založiť `projects/marek/tools.md`
- [ ] založiť `projects/marek/workflow.md`
- [ ] založiť `projects/marek/knowledge.md`
- [ ] založiť `projects/marek/review.md`
- [ ] založiť `projects/marek/qa.md`
- [ ] založiť `projects/marek/changelog.md`
