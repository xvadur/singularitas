...
- `business/voice/status.md`
- `business/voice/qa/2026-03-25-voice-snapshot.md`
- `business/voice/qa/2026-03-25-marek-runtime-validation-packet.md`
- `business/voice/qa/2026-03-25-marek-runtime-validation-result.md`
...
1. `business/voice/templates/review-template.md`
2. `business/voice/templates/prompt-patch-template.md`
3. `business/voice/inventory/elevenlabs-projects.md`
4. one concise "how to route voice requests" note for Jarvis → voice delegation

## Sources used for this inventory

- `business/voice/README.md`
- `business/voice/status.md`
- `business/voice/qa/2026-03-25-voice-snapshot.md`
- `business/voice/qa/2026-03-25-marek-runtime-validation-packet.md`
- `business/voice/qa/2026-03-25-marek-runtime-validation-result.md`
