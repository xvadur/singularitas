...
## 2026-03-26
- consolidated key canonical project material into `business/voice/clients/marek/`
...
- `docs/playbooks/integration/daily/`
- `business/voice/qa/`
- `outputs/`
- `outputs/runtime-handoffs/`
- `skills/voice-factory/references/`

These remain source/support artifacts, but `business/voice/clients/marek/` should now be treated as the primary working surface for this project.
