...
3. cleaned project docs in `projects/marek/`

This folder exists to make `projects/marek/` the canonical working surface for review, editing, QA, and eventual send-ready packaging.
