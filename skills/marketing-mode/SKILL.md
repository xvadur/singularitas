...
## Jozef Blog Integration

When producing long-form marketing content, prepare publish-ready drafts for:
- `/Users/_xvadur/.openclaw/workspace/projects/singularity/content/blog/`

Output should include:
- headline options
- slug suggestion
- final markdown draft
- CTA aligned to current offer
