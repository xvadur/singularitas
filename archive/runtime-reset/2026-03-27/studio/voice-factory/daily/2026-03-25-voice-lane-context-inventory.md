...
- `studio/voice-factory/daily/2026-03-25-voice-snapshot.md`
- `studio/voice-factory/daily/2026-03-25-marek-runtime-validation-packet.md`
...
1. `studio/voice-factory/templates/review-template.md`
2. `studio/voice-factory/templates/prompt-patch-template.md`
3. `studio/voice-factory/inventory/elevenlabs-projects.md`
4. one concise "how to route voice requests" note for Jarvis → voice delegation

## Sources used for this inventory

- `studio/voice-factory/README.md`
- `studio/voice-factory/status.md`
- `studio/voice-factory/daily/2026-03-25-voice-snapshot.md`
- `studio/voice-factory/daily/2026-03-25-marek-runtime-validation-packet.md`
- `studio/voice-factory/daily/2026-03-25-marek-runtime-validation-result.md`
